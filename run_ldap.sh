...
echo LDAP_HOST=$IP LDAP_DN=dc=code4health,dc=org LDAP_PASSWORD=devpassword prove -l t
LDAP_HOST=$IP LDAP_DN=dc=code4health,dc=org LDAP_PASSWORD=devpassword prove -l t
